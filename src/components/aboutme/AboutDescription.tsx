        ...
        <div className="w-full flex flex-col gap-14">
            {descriptionData.map((item, index) => (
                <div key={index} className="w-full flex flex-col gap-5 items-center">
                    <div className="w-full max-w-[750px] rounded-lg bg-pureWhite text-primary px-3 py-2 font-extrabold text-2xl flex items-center">
                        {item.title}
                    </div>
                    <ul className="w-full max-w-[750px] text-white text-xl flex flex-col gap-1">
                        <li>{item.text1}</li>
                        <li>{item.text2}</li>
                    </ul>
                </div>
